                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="{{$row->type == 'relationship' ? 'text-center' : ''}}">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            @endphp
                                            <td class="{{$row->type == 'relationship' ? 'text-center' : ''}}">
                                                ...
                                                @elseif($row->type == 'relationship')
                                                    <a href="{{config('app.url')}}/gallery/photos?key=category_id&filter=contains&s={{urlencode($data->name)}}">
